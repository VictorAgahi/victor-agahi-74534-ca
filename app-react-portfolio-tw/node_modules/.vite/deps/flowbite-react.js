...
import {
  ...
  shift,
  useFloating
} from "./chunk-5BBZKGPT.js";
import {
  require_jsx_runtime
} from "./chunk-6ANAV6IW.js";
import {
  require_react_dom
...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow2 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react34.useState)(Boolean(initialOpen));
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size2 }, children: (0, import_jsx_runtime69.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var SidebarContext = (0, import_react42.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react42.useContext)(SidebarContext);
  if (!context) {
...
var TabsComponent = (0, import_react56.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime87.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime87.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index2) => (0, import_jsx_runtime87.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index2}`, "aria-selected": index2 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index2 === activeTab && tabItemStyle.active.on, index2 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index2}`, onClick: () => handleClick({ target: index2 }), onKeyDown: (event) => handleKeyboard({ event, target: index2 }), ref: (element) => tabRefs.current[index2] = element, role: "tab", tabIndex: index2 === focusedTab ? 0 : -1, style: { zIndex: index2 === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime87.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index2)) }), (0, import_jsx_runtime87.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index2) => (0, import_jsx_runtime87.jsx)("div", { "aria-labelledby": `${id}-tab-${index2}`, className: theme2.tabpanel, hidden: index2 !== activeTab, id: `${id}-tabpanel-${index2}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index2)) })] });
});
