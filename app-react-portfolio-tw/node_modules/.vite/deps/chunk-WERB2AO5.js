...
// node_modules/stylis/src/Enum.js
var MS2, MOZ2, WEBKIT2, COMMENT2, RULESET2, DECLARATION2, IMPORT2, KEYFRAMES2, LAYER2;
...
var line2, column2, length2, position2, character2, characters2;
...
var identifierWithPointTracking3, toRules3, getRules3, fixedElements2, compat3, removeLabel3, ignoreFlag2, isIgnoringComment3, createUnsafeSelectorsAlarm3, isImportRule3, isPrependedWithRegularRules3, nullifyElement3, incorrectImportAlarm3, prefixer3, defaultStylisPlugins2, createCache3;
var init_emotion_cache_browser_esm2 = __esm({
  "node_modules/@emotion/cache/dist/emotion-cache.browser.esm.js"() {
    ...
    prefixer3 = function prefixer4(element, index, children, callback) {
      if (element.length > -1) {
        if (!element["return"])
          switch (element.type) {
            case DECLARATION2:
...
function breakpoints(styleFunction) {
  const newStyleFunction = (props) => {
    ...
    const extended = themeBreakpoints.keys.reduce((acc, key) => {
      if (props[key]) {
        acc = acc || {};
        acc[themeBreakpoints.up(key)] = styleFunction(_extends2({
          theme
        }, props[key]));
      }
      return acc;
  ...
  newStyleFunction.propTypes = true ? _extends2({}, styleFunction.propTypes, {
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match3, setMatch] = React11.useState(() => {
    if (noSsr && matchMedia) {
...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  ...
  const match3 = maybeReactUseSyncExternalStore(subscribe, getSnapshot, getServerSnapshot);
  return match3;
}
function useMediaQuery(queryInput, options = {}) {
  ...
  const match3 = useMediaQueryImplementation(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr);
  if (true) {
...
function useIsFocusVisible() {
  const ref = React19.useCallback((node3) => {
    if (node3 != null) {
...
function RtlProvider(_ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(RtlContext.Provider, _extends2({
...
function createGetCssVar(prefix5 = "") {
  function appendVar(...vars) {
    ...
    if (typeof value === "string" && !value.match(/(#|\(|\)|(-?(\d*\.)?\d+)(px|em|%|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc))|^(-?(\d*\.)?\d+)$|(\d+ \d+ \d+)/)) {
      return `, var(--${prefix5 ? `${prefix5}-` : ""}${value}${appendVar(...vars.slice(1))})`;
    }
    return `, ${value}`;
  }
  const getCssVar = (field, ...fallbacks) => {
    return `var(--${prefix5 ? `${prefix5}-` : ""}${field}${appendVar(...fallbacks)})`;
  };
  return getCssVar;
}
    ...
    (keys, value, arrayKeys) => {
      if (typeof value === "string" || typeof value === "number") {
        if (!shouldSkipGeneratingVar || !shouldSkipGeneratingVar(keys, value)) {
          const cssVar = `--${prefix5 ? `${prefix5}-` : ""}${keys.join("-")}`;
          Object.assign(css2, {
...
function createCssVarsTheme(theme) {
  ...
  return _extends2({}, theme, prepareCssVars_default(otherTheme, {
    prefix: cssVarPrefix,
    shouldSkipGeneratingVar
  }));
}
...
function createContainer(options = {}) {
  ...
  const Container2 = React30.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime11.jsx)(ContainerRoot, _extends2({
        as: component,
        ownerState,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React31.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime12.jsx)(GridRoot, _extends2({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
function createStack(options = {}) {
  ...
  const Stack2 = React32.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(StackRoot, _extends2({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WERB2AO5.js.map
